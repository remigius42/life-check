...
> Voltage math, GPIO pin selection, pull-up rationale: [`notes/hardware-wiring.md`](../../notes/hardware-wiring.md)
...
> C++ array global syntax, FIFO shift lambda: [`notes/esphome-implementation.md`](../../notes/esphome-implementation.md)
...
> Retry loop pattern, 3-tier message lambda, http_request action usage: [`notes/esphome-implementation.md`](../../notes/esphome-implementation.md)
...
> Script pattern with `mode: restart` and `script.stop`: [`notes/esphome-implementation.md`](../../notes/esphome-implementation.md)
...
- **WHEN** a user opens the web UI
- **THEN** beam state, today's count, test mode switch, and all configurable text fields are displayed
